  ...
  return (
    ...
    >
      ...
      <Tab.Screen
        ...
        options={{
          tabBarIcon: ({ color, size }) => (
            <Icon name='search' color={color} type='font-awesome' size={size} />
          ),
        }}
      />
      <Tab.Screen
        ...
        options={{
          tabBarIcon: ({ color, size }) => (
            <Icon name='message-circle' type='font-awesome' color={color} size={size} />
          ),
        }}
      />
      <Tab.Screen
      ...
      <Tab.Screen
        ...
        options={{
          tabBarIcon: ({ color, size }) => (
            <Icon name='settings' type='font-awesome' color={color} size={size} />
          ),
        }}
      />
    </Tab.Navigator>
